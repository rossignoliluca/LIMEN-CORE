/**
 * LIMEN Response Plan - Structured Speech Acts
 *
...
import { SupportedLanguage, ForbiddenAction, RequiredAction } from '../../interface/types';
...
export type SpeechActType =
  ...
  | 'boundary'       // Mark what LIMEN cannot/will not do
