 ...
 *
 * Pure factory functions for creating ResponsePlan objects.
 * These only depend on interface/types.ts.
 *
 * Moved from mediator/l5_transform/response_plan.ts to interface/
 * so that gate/ modules can use them without cross-layer imports.
 */
