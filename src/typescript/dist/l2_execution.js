...
exports.SURFACE_TEMPLATES = exports.RUNTIME_CAPABILITIES = void 0;
exports.selectRuntime = selectRuntime;
exports.compileExecutionContext = compileExecutionContext;
exports.execute = execute;
exports.verifyL2Blindness = verifyL2Blindness;
exports.hashExecutionContext = hashExecutionContext;
const llm_provider_1 = require("./llm_provider");
exports.RUNTIME_CAPABILITIES = {
    'L2_SURFACE': {
        llm_calls: 0,
        max_latency_ms: 100,
        deterministic: true,
...
// CONSTANTS
// ============================================
const LENGTH_TO_TOKENS = {
    'minimal': 50,
    'brief': 100,
    'moderate': 200,
};
const RUNTIME_LATENCY = {
    'L2_SURFACE': 100,
    'L2_MEDIUM': 500,
    'L2_DEEP': 2000,
};
const RUNTIME_LLM_CALLS = {
    'L2_SURFACE': 0,
    'L2_MEDIUM': 1,
    'L2_DEEP': 2,
};
...
function mostRestrictiveDepth(a, b, c) {
    const order = ['surface', 'medium', 'deep'];
    const depths = [a, b, c].filter((d) => d !== undefined);
...
// RUNTIME SELECTION
// ============================================
function selectRuntime(atmosphere, arousal, l2Mode) {
...
// CONTEXT COMPILATION
// ============================================
function compileExecutionContext(field, selection, governor, metaKernel) {
    // Select runtime (L2 will NOT see why)
    const runtime = selectRuntime(selection.atmosphere, field.arousal, metaKernel.power_envelope.l2_mode);
    ...
    const constraints = {
        ...
        depth_ceiling: mostRestrictiveDepth(selection.depth, governor.effect.depth_ceiling, metaKernel.power_envelope.depth_ceiling),
    ...
    // Output spec
    const output_spec = runtime === 'L2_SURFACE'
...
function getActiveInvariants(atmosphere) {
...
function executeSurface(context) {
 ...
 */
function verifyL2Blindness(context) {
...
//# sourceMappingURL=l2_execution.js.map