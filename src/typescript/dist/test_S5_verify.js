...
const S5_verify_1 = require("./S5_verify");
// ============================================
// TEST HELPERS
// ============================================
function createTestInput(text, overrides = {}) {
    const field = {
        domains: [{ domain: 'H06_MEANING', salience: 0.7 }],
        arousal: overrides.arousal || 'medium',
        valence: 'neutral',
        coherence: 'medium',
        goal: 'explore',
        loop_count: 0,
    ...
    const selection = {
        atmosphere: overrides.atmosphere || 'HUMAN_FIELD',
        mode: 'EXPAND',
        primitive: 'P04_OPEN',
        depth: 'medium',
        length: 'moderate',
...
{
    const input = createTestInput('I recommend you take the job in Singapore.', { forbidden: ['recommend'] });
    const result = (0, S5_verify_1.verify)(input);
...
{
    const input = createTestInput('You should definitely stay with your family.', { forbidden: ['recommend'] });
    const result = (0, S5_verify_1.verify)(input);
...
{
    const input = createTestInput('Ti consiglio di accettare il lavoro.', { forbidden: ['recommend'] });
    const result = (0, S5_verify_1.verify)(input);
...
{
    const input = createTestInput('You have anxiety. This sounds like depression.', { forbidden: ['diagnose'] });
    const result = (0, S5_verify_1.verify)(input);
...
{
    const input = createTestInput('What do you think about this situation?', { forbidden: ['recommend', 'diagnose'] });
    const result = (0, S5_verify_1.verify)(input);
...
{
    const input = createTestInput('Singapore has great career opportunities.', { required: ['return_ownership'], flags: ['delegation_attempt'] });
    const result = (0, S5_verify_1.verify)(input);
...
{
    const input = createTestInput('Singapore has opportunities. What do you think feels right for you?', { required: ['return_ownership'], flags: ['delegation_attempt'] });
    const result = (0, S5_verify_1.verify)(input);
...
{
    const input = createTestInput('Let me analyze this problem.', { required: ['validate_feeling'] });
    const result = (0, S5_verify_1.verify)(input);
...
{
    const input = createTestInput('The right thing to do is stay with your family.', { flags: ['delegation_attempt'] });
    const result = (0, S5_verify_1.verify)(input);
...
{
    const input = createTestInput('Your purpose is to serve others. You are meant to be a healer.', {});
    const result = (0, S5_verify_1.verify)(input);
...
{
    const input = createTestInput('There are many factors to consider here.', { flags: ['delegation_attempt'], atmosphere: 'V_MODE' });
    const result = (0, S5_verify_1.verify)(input);
...
{
    const input = createTestInput('If I were you, I would take the job.', { atmosphere: 'V_MODE' });
    const result = (0, S5_verify_1.verify)(input);
...
{
    const input = createTestInput('Let me help you analyze your options.', { atmosphere: 'EMERGENCY', required: ['offer_grounding'] });
    const result = (0, S5_verify_1.verify)(input);
...
{
    const input = createTestInput("I'm here with you. Let's breathe together. What do you notice in your body?", { atmosphere: 'EMERGENCY', required: ['offer_grounding', 'acknowledge_distress'] });
    const result = (0, S5_verify_1.verify)(input);
...
// Test: High arousal response too long
{
    ...
    const input = createTestInput(longResponse, { arousal: 'high' });
...
{
    const input = createTestInput('I recommend you stay.', { forbidden: ['recommend'] });
    const result = (0, S5_verify_1.verify)(input, 0);
...
{
    const input = createTestInput('I recommend you stay.', { forbidden: ['recommend'] });
    const result = (0, S5_verify_1.verify)(input, 2);
...
{
    const input = createTestInput('The right thing to do is leave.', {});
    const result = (0, S5_verify_1.verify)(input, 0);
...
{
    const input = createTestInput('What do you think?', {});
    const result = (0, S5_verify_1.verify)(input);
...
{
    const output = (0, S5_verify_1.getFallbackOutput)('PRESENCE', {}, 'en');
...
{
    const selection = { atmosphere: 'V_MODE' };
    const output = (0, S5_verify_1.getFallbackOutput)('SURFACE', selection, 'en');
...
{
    const output = (0, S5_verify_1.getFallbackOutput)('PRESENCE', {}, 'it');
...
//# sourceMappingURL=test_S5_verify.js.map