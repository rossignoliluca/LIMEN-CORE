...
exports.generateDomainResponse = generateDomainResponse;
// ============================================
// SOMATIC RESPONSES
// ============================================
const SOMATIC_RESPONSES = {
    emergency: {
        en: [
 ...
 */
function generateAgentResponse(agentType, subtype, context) {
 ...
 */
function selectWithVariation(templates, phi, recentResponses) {
 ...
 */
function generateContextualResponse(dimensionalState, language) {
    const elements = [];
    const context = {
        language,
 ...
 */
function generateDomainResponse(domain, language, variationIndex = 0) {
...
//# sourceMappingURL=agent_responses.js.map