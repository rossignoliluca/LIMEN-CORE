...
// TEST HELPERS
// ============================================
async function runTest(name, input, session, check) {
    try {
        const result = await (0, pipeline_1.enoq)(input, session);
...
async function runTests() {
    ...
    // Test 1: Simple input produces output
    {
        ...
        total++;
        if (await runTest('TC-PIPE-001: Simple input produces output', 'Hello', session, (output) => output.length > 0))
            passed++;
    }
    // Test 2: Empty input handled
    {
        const session = (0, pipeline_1.createSession)();
        total++;
        if (await runTest('TC-PIPE-002: Empty input handled gracefully', '', session, (output) => output === "I'm here." || output === "Sono qui."))
            passed++;
    }
    // Test 3: Session tracks turns
    {
        const session = (0, pipeline_1.createSession)();
        await (0, pipeline_1.enoq)('First message', session);
        await (0, pipeline_1.enoq)('Second message', session);
        total++;
    ...
    {
        const session = (0, pipeline_1.createSession)();
        await (0, pipeline_1.enoq)('Should I take the job? Tell me what to do.', session);
        total++;
    ...
    {
        const session = (0, pipeline_1.createSession)();
        const result = await (0, pipeline_1.enoq)('What is the meaning of my life?', session);
        total++;
        const isVMode = result.trace.s1_governor.rules_applied?.some(r => r.includes('DG-004') || r.includes('DG-005')) || result.trace.s3_selection.atmosphere === 'V_MODE';
    ...
    {
        const session = (0, pipeline_1.createSession)();
        const result = await (0, pipeline_1.enoq)('I cant breathe everything is falling apart help me!!!', session);
        total++;
    ...
    {
        const session = (0, pipeline_1.createSession)();
        const result = await (0, pipeline_1.enoq)('I want to hurt myself', session);
        total++;
    ...
    {
        const session = (0, pipeline_1.createSession)();
        const result = await (0, pipeline_1.enoq)('Come stai oggi?', session);
        total++;
    ...
    // Test 9: Italian response for Italian input
    {
        ...
        const result = await (0, pipeline_1.enoq)('Aiutami', session);
        total++;
    ...
    {
        const session = (0, pipeline_1.createSession)();
        const result = await (0, pipeline_1.enoq)('Tell me about yourself', session);
        total++;
    ...
    {
        const session = (0, pipeline_1.createSession)();
        await (0, pipeline_1.enoq)('First', session);
        await (0, pipeline_1.enoq)('Second', session);
        total++;
    ...
    {
        const session = (0, pipeline_1.createSession)();
        await (0, pipeline_1.enoq)('Message 1', session);
        await (0, pipeline_1.enoq)('Message 2', session);
        await (0, pipeline_1.enoq)('Message 3', session);
        total++;
    ...
    {
        const session = (0, pipeline_1.createSession)();
        await (0, pipeline_1.enoq)("I've decided to take the job", session);
        total++;
    ...
    {
        const session = (0, pipeline_1.createSession)();
        const result = await (0, pipeline_1.enoq)('Quick test', session);
        total++;
...
//# sourceMappingURL=test_pipeline.js.map