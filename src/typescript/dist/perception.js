...
// AROUSAL DETECTION
// ============================================
function detectArousal(message) {
...
// VALENCE DETECTION
// ============================================
function detectValence(message) {
...
// GOAL DETECTION
// ============================================
function detectGoal(message, domains) {
...
// FLAG DETECTION
// ============================================
function detectFlags(message, arousal) {
    const flags = [];
...
// COHERENCE DETECTION
// ============================================
function detectCoherence(message) {
...
// TEMPORAL DETECTION
// ============================================
function detectTemporal(message) {
...
// ============================================
function perceive(message, conversationHistory = []) {
