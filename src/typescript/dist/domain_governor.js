...
exports.DOMAIN_GOVERNOR_RULES = void 0;
exports.applyDomainGovernor = applyDomainGovernor;
exports.checkInvariants = checkInvariants;
// ============================================
// HELPER FUNCTIONS
// ============================================
function getDomainSalience(field, domain) {
    const found = field.domains.find(d => d.domain === domain);
    return found?.salience || 0;
}
function hasDomain(field, domain, minSalience = 0) {
    return getDomainSalience(field, domain) > minSalience;
}
function isDominant(field, domain) {
...
function getPrecedenceRank(precedence) {
...
// ============================================
const PACING_ORDER = ['slow', 'conservative', 'normal', 'responsive'];
function slowestPacing(a, b) {
    if (!b)
        return a;
...
const DOMAIN_GOVERNOR_RULES = [
    ...
    // Rule 006: ATTACHMENT + EMOTION = Careful
    {
        ...
        activation: {
            ...
            evaluate: (field) => getDomainSalience(field, 'H09_ATTACHMENT') > 0.4 &&
                field.arousal !== 'low',
        },
        effect: {
    ...
    // Rule 007: COGNITION Alone = Can Analyze
    {
        ...
        activation: {
            ...
            evaluate: (field) => isDominant(field, 'H05_COGNITION') &&
    ...
    // Rule 008: CREATION + WORK = Execute
    {
        ...
        activation: {
            ...
            evaluate: (field) => (isDominant(field, 'H13_CREATION') || isDominant(field, 'H14_WORK')) &&
                field.arousal === 'medium' &&
                field.coherence !== 'low',
        },
        effect: {
    ...
    // Rule 009: MEANING + SURVIVAL = Crisis
    {
        ...
        activation: {
            ...
            evaluate: (field) => hasDomain(field, 'H06_MEANING', 0.4) &&
    ...
    // Rule 011: TEMPORAL Pressure + DECISION = Slow Down
    {
        ...
        activation: {
            ...
            evaluate: (field) => hasDomain(field, 'H08_TEMPORAL', 0.5) &&
                field.goal === 'decide',
        },
        effect: {
            atmosphere: 'DECISION',
    ...
    // Rule 012: BELONGING + IDENTITY = Sensitive
    {
        ...
        activation: {
            criterion: 'both salient',
            evaluate: (field) => hasDomain(field, 'H11_BELONGING', 0.4) &&
    ...
    // Rule 013: HIERARCHY + EMOTION = Careful
    {
        ...
        activation: {
            ...
            evaluate: (field) => hasDomain(field, 'H12_HIERARCHY', 0.4) &&
                field.arousal !== 'low',
        },
        effect: {
            atmosphere: 'HUMAN_FIELD',
    ...
    // Rule 014: LEGAL Alone = Informational
    {
        ...
        activation: {
            ...
            evaluate: (field) => isDominant(field, 'H15_LEGAL') &&
                field.arousal !== 'high' &&
    ...
    // Rule 015: BODY + SAFETY = Medical Caution
    {
        ...
        activation: {
            ...
            evaluate: (field) => hasDomain(field, 'H03_BODY', 0.4) &&
...
exports.DOMAIN_GOVERNOR_RULES = DOMAIN_GOVERNOR_RULES;
// ============================================
// MAIN FUNCTION
// ============================================
function applyDomainGovernor(field) {
    ...
    applicableRules.sort((a, b) => getPrecedenceRank(a.precedence) - getPrecedenceRank(b.precedence));
    // 3. Merge effects
    const merged = {
        atmosphere: null,
        mode: null,
...
function checkInvariants(field, result) {
    const violations = [];
    // INV-1: SURVIVAL > ALL
...
exports.default = applyDomainGovernor;
//# sourceMappingURL=domain_governor.js.map