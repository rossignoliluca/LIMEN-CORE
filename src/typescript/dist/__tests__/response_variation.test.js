...
describe('Response Variation', () => {
    ...
    describe('should produce varied responses even with phi=0', () => {
        it('generates different responses over multiple calls', () => {
            ...
            for (let i = 0; i < 20; i++) {
                const response = (0, agent_responses_1.generateAgentResponse)('FUNCTIONAL', 'decision', baseContext);
    ...
    describe('should filter out recent responses', () => {
        it('avoids responses in recentResponses array', () => {
            ...
            const responses = [];
            for (let i = 0; i < 50; i++) {
                const response = (0, agent_responses_1.generateAgentResponse)('FUNCTIONAL', 'decision', contextWithRecent);
...
describe('Agent Response Types', () => {
    ...
    describe('SOMATIC emergency responses', () => {
        languages.forEach(lang => {
            it(`has emergency responses in ${lang}`, () => {
                ...
                const response = (0, agent_responses_1.generateAgentResponse)('SOMATIC', 'emergency', context);
    ...
    describe('V_MODE responses', () => {
        languages.forEach(lang => {
            it(`has V_MODE inquiry responses in ${lang}`, () => {
                ...
                const response = (0, agent_responses_1.generateAgentResponse)('V_MODE', 'inquiry', context);
                expect(response).toBeTruthy();
                expect(response.length).toBeGreaterThan(10);
            });
        });
    ...
    describe('EXISTENTIAL responses', () => {
        it('returns meaningful existential responses', () => {
            ...
            const response = (0, agent_responses_1.generateAgentResponse)('EXISTENTIAL', 'meaning', context);
            expect(response).toBeTruthy();
...
//# sourceMappingURL=response_variation.test.js.map