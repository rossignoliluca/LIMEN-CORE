...
export interface LexiconMatch {
  ...
  /** Boost strength (0.2 = weak, 0.4 = medium, 0.6 = strong) */
  boost: number;
...
export interface LexiconResult {
  /** Maximum boost from all matches */
  boost: number;

  /** All matches found */
  matches: LexiconMatch[];

  /** Whether any existential marker was found */
...
/**
 * Italian existential markers
 */
const ITALIAN_MARKERS: MarkerDef[] = [
  // Totalization + exhaustion
...
/**
 * German existential markers (basic)
 */
...
/**
 * French existential markers (basic)
 */
...
/**
 * Spanish existential markers (basic)
 */
 ...
 * The boost is the MAXIMUM of all matching markers.
 */
 ...
 *
 * This ensures that messages with existential markers
 * have at least some existential signal, even if regex misses them.
 */
